...
```python
labels_iterator= train_dataset.unbatch().map(lambda image, label: label)
.as_numpy_iterator()
sum(labels_iterator)
```
```python
...
![PIC1.png](https://raw.githubusercontent.com/xinyudong1129/xinyudong1129.github.io/master/images/pic1_cat_dog.png)

## 2. First Model-Model1

We create a *tf.keras.Sequential* model called model1, which includes two *Conv2D* layers, two *MaxPooling2D* layers, one *Flatten* layer, one *Dense* layer, one *Dropout* layer.
...
plt.legend()
```
![PIC2.png](https://raw.githubusercontent.com/xinyudong1129/xinyudong1129.github.io/master/images/pic2_model1_history.png)
...
![PIC3.png](https://raw.githubusercontent.com/xinyudong1129/xinyudong1129.github.io/master/images/pic3_augmentation.png)
...
for image, _ in train_dataset.take(1):
  ...
  for i in range(9):
    ...
    plt.axis('off')
```
![PIC4.png](https://raw.githubusercontent.com/xinyudong1129/xinyudong1129.github.io/master/images/pic4_rotation.png)
...
![PIC6.png](https://raw.githubusercontent.com/xinyudong1129/xinyudong1129.github.io/master/images/pic6_model2_history.png)
...
![PIC7.png](https://raw.githubusercontent.com/xinyudong1129/xinyudong1129.github.io/master/images/pic7_model3_history.png)
...
plt.show()
```
![PIC5.png](https://raw.githubusercontent.com/xinyudong1129/xinyudong1129.github.io/master/images/pic5_model4.png)
