...
The following are some of the settings used: For example, we modify the background color, text font and size, layout, and backgroud picture of webpage, and we change the style of the text input box by adding vertical scroll bar and the background pictures.
